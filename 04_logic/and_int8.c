/* TPU AND: bitwise AND of two INT8 tensors */
#include "../common/tpu_bench.h"
#define N 16
static const int8_t a[N] = {0x0F,0xF0,0xAA,0x55,0xFF,0x00,0x77,0x88,
                             0x33,0xCC,0x11,0xEE,0x3C,0xC3,-1,-128};
static const int8_t b[N] = {0xFF,0x0F,0xFF,0xFF,0xAA,0x55,0xFF,0xFF,
                             0xFF,0xCC,0xFF,0xEE,0xFF,0xC3, 15, 127};
static const int8_t exp[N]={0x0F,0x00,0xAA,0x55,0xAA,0x00,0x77,0x88,
                             0x33,0xCC,0x11,0xEE,0x3C,0xC3, 15, 0};
...
int main() {
  ...
  cvk_tiu_and_int8_param_t p = {tl_r, tl_a, tl_b};
  cvk->ops->tiu_and_int8(cvk, &p);
  ...
  int errs = tpu_check_i8("and", (int8_t*)ctx.neuron_vaddr+32, exp, N, N);
  printf("  time: %.2f us\n", t_ns/1000.0);
