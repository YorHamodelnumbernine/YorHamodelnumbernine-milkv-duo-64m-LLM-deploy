/* TPU max_pooling: 2x2 max pool on 4x4 INT8 input, stride 2, valid padding */
...
/* Output: 2x2 max pool with 2x2 kernel, stride 2, no padding */
static const int8_t exp[4] = {7, 8, 15, 16};
...
int main() {
  ...
  int errs = tpu_check_i8("maxpool", (int8_t*)ctx.neuron_vaddr+16, exp, 4, 4);
  printf("  time: %.2f us\n", t_ns/1000.0);
